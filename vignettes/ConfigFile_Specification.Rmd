...
To ease the generation of configuration file for many samples, you can 
...
### Write YAML file
Alternatively, the function can be used to generate config file with preset values. 
You can then modify the generated YAML-file with any texteditor of your choice. 
