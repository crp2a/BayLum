...
which provides an excellent desktop working environment for **R**.

Despite, you will need the external software *JAGS* (Just Another Gibs Sampler). 
Please visit the [JAGS](http://mcmc-jags.sourceforge.net) webpage and follow the install instructions. 
