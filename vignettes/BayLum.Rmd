...
sample for single grain (SG) or multigrain (MG) OSL measurements. Stratigraphic constraints and 
...
[R project](https://www.r-project.org) webpage and download and install **R**. 
You may also consider installing [Rstudio](http://www.rstudio.com), 
...
### Combine files using the function `Concat_DataFile()`
...
Either you enter a sample name (corresponding to subfolder names) in `Names` parameter of the function `Generate_DataFile()`, ordered by order of increasing ages or you enter saved .RData informations of each sample in `Concat_DataFile()`, ordered by increasing ages.
...
Philippe, A., Guérin, G., Kreutzer, Sebastian Kreutzer, in press. BayLum - An R package for Bayesian analysis of OSL ages: An introduction.
Quaternary Geochronology. doi: [10.1016/j.quageo.2018.05.009](https://doi.org/10.1016/j.quageo.2018.05.009)
