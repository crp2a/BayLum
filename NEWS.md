...
## BayLum 0.2.0 (2021-06-01)

### Bugfixes & changes

#### `Generate_DataFile_MG()`

-   The function now automatically orders BIN/BINX-files follwing the
    Run 1 at a time option. Regardless of whether this option was used
    during for the measurement.
