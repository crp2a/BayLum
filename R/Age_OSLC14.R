...
#' Allowed inputs are
#' \itemize{
#'   \item `"AtmosphericNorth"` for Northern Hemisphere atmospheric radiocarbon calibration curve,
#'   \item `"Marine"` for Marine radiocarbon calibration curve,
#'   \item `"AtmosphericSouth"` for Southern Hemisphere atmospheric radiocarbon calibration curve,
#'   \item \bold{a CSV-file, with tree columns, the first column is dedicated to `Cal.BP`, the second to `X14C.age`,
#'   the third to `Error`. The decimal delimiter of this file must be a dot, and the separator must be a comma.}
#' }
#'
