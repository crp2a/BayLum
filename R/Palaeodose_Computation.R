...
Palaeodose_Computation<-function(DATA,SampleNames,Nb_sample,
  ...
  jags <-  rjags::jags.model(textConnection(Model_Palaeodose[[Model_GrowthCurve]][[distribution]]), data = dataList, n.chains = Nb_chaines, n.adapt=Taille)
  update(jags,Taille)
  echantillon =  rjags::coda.samples(jags,c("D","sD"),min(Taille,5000),thin=t)
  ...
  for(i in 1:Nb_sample){
    ...
    cat("---------------------\n")
    cat(paste("\t\t", "Point estimate", "Uppers credible interval\n"))
