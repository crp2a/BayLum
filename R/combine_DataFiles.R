#' Combine objects generated by [Generate_DataFile] or [Generate_DataFile_MG]
#'
#' @details
#'
...
#' works similar to the standard R base function `c()`, but preserves the particular structure of the
#' objects imported and generated by 'BayLum'.
#'
#' Combining such data is in particular useful in two scenarious:
#'
#' \itemize{
#'  \item The data have been already imported and treated and then stored in RData-files. Using the function
#'  `combine_DataFiles` will significantely safe processing time.
#'  \item Simultaneous analysis of single and multi-grain OSL measurements.
#' }
#'
#'
#' @param ... objects you want to combine
#'
#' @return A nested list of the input objects, each list element is combine by the list element name.
#'
