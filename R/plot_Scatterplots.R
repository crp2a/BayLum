#' Create Scatter Plot Matrix of the Bayesian Age Results
#'
#' Create a hexbin plot matrix ([hexbin::hexplom]) of age results returned by age calculation.
#'
...
#'
#' @param variables [character]: variable to be selected for the scatter plot, e.g., `"A"`. Please note
...
#' function `plot_Scatterplots()` by Claire Christophe, Anne Philippe, Guillaume Guérin
#'
