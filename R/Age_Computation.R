...
Age_Computation<-function(DATA,samplename,
  ...
  HPD_95=CredibleInterval(echantillon[[1]][,1],0.95)
  HPD_68=CredibleInterval(echantillon[[1]][,1],0.68)
  ...
  HPD_95=CredibleInterval(echantillon[[1]][,2],0.95)
  HPD_68=CredibleInterval(echantillon[[1]][,2],0.68)
  cat("\t\t\t\t\t\t lower bound \t upper bound\n")
  cat("\t\t\t\t at level 95%\t",round(c(HPD_95[2]),2),"\t\t",round(c(HPD_95[3]),2),"\n")
  cat("\t\t\t\t at level 68%\t",round(c(HPD_68[2]),2),"\t\t",round(c(HPD_68[3]),2),"\n")
  ...
  HPD_95=CredibleInterval(echantillon[[1]][,3],0.95)
  HPD_68=CredibleInterval(echantillon[[1]][,3],0.68)
  cat("\t\t\t\t\t\t lower bound \t upper bound\n")
  cat("\t\t\t\t at level 95%\t",round(c(HPD_95[2]),2),"\t\t",round(c(HPD_95[3]),2),"\n")
  cat("\t\t\t\t at level 68%\t",round(c(HPD_68[2]),2),"\t\t",round(c(HPD_68[3]),2),"\n")
