...
#'  }
#'  \item **The Gelman and Rubin test of convergence**: prints the result of the Gelman and Rubin test of convergence for the age, palaeodose and equivalent dose dispersion parameters.
...
#' the user can consider the printed estimates as valid. Otherwise, the user may try increasing the number of MCMC iterations
...
#' or changing the parameter `distribution` or the growth curve, to reach convergence.to reach convergence.
#' \item **Credible intervals and Bayes estimates**: prints the Bayes estimates, the credible intervals at 95% and 68% for
...
#'
#' @seealso [Generate_DataFile], [Generate_DataFile_MG], [rjags::rjags-package], [plot_MCMC], [AgeS_Computation], [Palaeodose_Computation]
#'
#' @references
