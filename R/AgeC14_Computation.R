...
#'
#' @param Data_SigmaC14Cal [numeric] (**required**): correponding to the error of C-14 age estimates.
#'
#' @param SampleNames [character] (**required**): names of sample. The length of this vector is equal to \code{Nb_sample}.
#'
...
#'
#' @param OutputTableName [logical] (with default): name of the table that will be generated by the function if \code{SaveEstimates}=TRUE.
#'
